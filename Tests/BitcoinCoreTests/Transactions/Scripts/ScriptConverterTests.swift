...
//        let chunks = [Chunk(scriptData: data, index: 0), Chunk(scriptData: data, index: 1, payloadRange: 2..<4),
//        Chunk(scriptData: data, index: 4)]
//
//        do {
...
//        let chunks = [Chunk(scriptData: data, index: 0, payloadRange: 1..<73), Chunk(scriptData: data, index: 73,
//        payloadRange: 74..<107)]
//        do {
//            let result = try converter.decode(data: data)
//            XCTAssertEqual(result.chunks, chunks)
